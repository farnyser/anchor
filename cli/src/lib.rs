...
fn idl(cfg_override: &ConfigOverride, subcmd: IdlCommand) -> Result<()> {
    match subcmd {
        ...
        } => idl_set_authority(cfg_override, program_id, address, new_authority, print_only, priority_fee),
        IdlCommand::EraseAuthority { program_id, priority_fee,
...
fn idl_close(cfg_override: &ConfigOverride, program_id: Pubkey, print_only: bool, priority_fee: Option<u64>) -> Result<()> {
    with_workspace(cfg_override, |cfg| {
